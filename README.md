...
* **Data Analytics:** Criação de dashboards estratégicos e análise de indicadores (KPIs).
* **Automação de Dados:** Extração e tratamento de dados via APIs e workflows inteligentes.
...
[![My Skills](https://skillicons.dev/icons?i=python,mysql,postgres,postman,git,github)](https://skillicons.dev)
